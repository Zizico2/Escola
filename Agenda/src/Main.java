...
public class Main {
	//Constantes que definem os comandos
	 ...
	 public static final String DUPLICATE_PHONE_NOT_EXIST = "All contacts have different phone numbers.";
	 public static final String DUPLICATE_PHONE_EXIST = "There are contacts that share phone numbers.";
